...
MaximeDore.meals.push(new Meals('breakfast', '2017-01-13', 'eggs', 200));
MaximeDore.meals.push(new Meals('lunch', '2017-01-13', 'burger', 800));
...
const avgDailyCalories = function (caloriesEatenOn) {
  //take dailyCalories
  const dailyCalories = caloriesEatenOn();
  //add all the daily calories

// calculate number of numOfDays
for (let i = 0; i < Meals.date.length; i++) {

//divide total calories by total number of days
